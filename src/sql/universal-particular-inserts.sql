-- Insert sentences from "The Universal And The Particular" with notebook_id = 30

INSERT INTO public.sentences (text, text_zh, notebook_id) VALUES 
('What I learned on my own I still remember.', '我自己学到的东西，我仍然记得。', 30),
('Regular minds find similarities in stories (and situations); finer minds detect differences.', '普通的头脑在故事（和情况）中寻找相似性；更敏锐的头脑发现差异。', 30),
('To grasp the difference between Universal and Particular, consider that some dress better to impress a single, specific person than an entire crowd.', '要理解普遍与特殊的区别，想想有些人为了打动一个特定的人而穿得更好，而不是为了整个人群。', 30),
('We unwittingly amplify commonalities with friends, dissimilarities with strangers, and contrasts with enemies.', '我们不知不觉地放大与朋友的共同点，与陌生人的差异，以及与敌人的对比。', 30),
